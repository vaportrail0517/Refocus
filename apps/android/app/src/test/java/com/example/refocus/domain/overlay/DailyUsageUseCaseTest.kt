...
class DailyUsageUseCaseTest {
    ...
    @Test
    fun onTick_doesNotAccumulateAcrossMidnightWhenSnapshotIsNotReady() = runBlocking<Unit> {
        val pkgA = "com.example.a"
    ...
    @Test
    fun refreshIfNeeded_doesNotDropRuntimeDeltaAccumulatedDuringRefresh() = runBlocking<Unit> {
        val pkgA = "com.example.a"
        val pkgB = "com.example.b"
