...
object SuggestionStatsCalculator {
    ...
    private val decisionTypes = setOf(
    ...
    fun buildDailyStats(
        ...
        for (session in sessions) {
            ...
            for ((index, e) in events.withIndex()) {
                ...
                val shownDate = Instant.ofEpochMilli(e.timestampMillis)
                    .atZone(zoneId)
                    .toLocalDate()
