...
internal val TimeSlotsStateSaver =
    listSaver<Set<SuggestionTimeSlot>, String>(
        save = { slots ->
...
internal fun slotOrder(): List<SuggestionTimeSlot> =
    listOf(
...
internal fun SuggestionTimeSlot.labelJa(): String =
    when (this) {
...
internal fun SuggestionTimeSlot.hintJa(): String =
    when (this) {
        SuggestionTimeSlot.Anytime -> "いつでも"
